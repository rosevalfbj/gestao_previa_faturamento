...
JAVA_OPTS="$JAVA_OPTS -DappConfig=/app/tomcat8/previafaturamento/application.properties.xml"

#Variaveis CATALINA_OPTS
CATALINA_OPTS="$CATALINA_OPTS -Dcom.sun.management.jmxremote.port=3002"
