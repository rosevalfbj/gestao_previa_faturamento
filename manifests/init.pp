...
class gestao_previa_faturamento (
  ...
  String $jdbc                          = 'jdbc/dbm_mailing',
  String $initialSize                   = '10',
  String $maxIdle                       = '20',
  String $maxWaitMillis                 = '300',
  String $maxTotal                      = '250',
  String $url_banco                     = 'jdbc:oracle:thin:@geoprddb01.network.ctbc:1521/GEOMKTHML',
  String $username                      = 'mailingapp',
  String $password                      = 'MA#IL9IN0GA#PP',
